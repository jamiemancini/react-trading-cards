...
ReactDOM.render(<TradingCardContainer />, document.querySelector('#root'));
...
// ReactDOM.render(
//   <TradingCard name="Seedpy" skill="garden" imgUrl="/static/img/seedpy.jpeg" />,
//   document.querySelector('#seedpy'),
// );

// ReactDOM.render(
//   <TradingCard name="Merge" skill="bullet journaling" imgUrl="/static/img/merge.png" />,
